...
public:
	...
	void UpdateChunkMesh(std::map<int, int> ThingIDmap, int ThingIDsize); //(Used to update the chunk's mesh/visuals to better represent the current state of the chunk.)
